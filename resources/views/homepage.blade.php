...
@section('content')
    <h1 class="text-2xl font-bold mb-4">Ini Homepage</h1>
    <p class="mb-4">Berikut ini data-datanya</p>
        ...
        <table class="min-w-full border border-pink-300">
            <thead class="bg-pink-200">
                <tr>
                    ...
                    <th class="border border-pink-300 px-4 py-2 text-left">Name</th>
            ...
            <tbody>
                @foreach ($contacts as $contact)
                    <tr class="{{ $loop->iteration % 2 == 0 ? 'bg-pink-100' : 'bg-white' }}">
